...
// const multipliedArray106 = ungroupAndApply(
//   zipArray106,
//   (num, charOrArray) => {
//     const charArray = Array.isArray(charOrArray) ? charOrArray : [charOrArray];
//     return num * charArray.map(char => char.charCodeAt(0)).reduce((acc, val) => acc + val, 0);
//   }
// );

// console.log(multipliedArray106);
